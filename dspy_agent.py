...
import os
lm = dspy.LM("gemini/gemini-2.5-flash", api_key="AIzaSyAMdrluj0tkd5yC2HZPuTUxZKwIFLJGFdE")

dspy.configure(lm=lm)
result = agent(user_request="please help me book a flight from SFO to JFK on 09/01/2025")
print(result)